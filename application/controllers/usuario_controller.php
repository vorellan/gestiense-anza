...
class Usuario_controller extends Controller {//@
	...
	function grid($keyTab=''){
		...
		$o->usuario=(isset($_REQUEST['f_usuario']))?$_REQUEST['f_usuario']:'';
		$o->facultad=(isset($_REQUEST['f_facultad']))?$_REQUEST['f_facultad']:'';
		$o->password=(isset($_REQUEST['f_password']))?$_REQUEST['f_password']:'';
		$o->tipo_usuario=(isset($_REQUEST['f_tipo_usuario']))?$_REQUEST['f_tipo_usuario']:'';
	...
	function insertar(){
		...
		$o->usuario=$_REQUEST['usuario'];
		$o->facultad=$_REQUEST['facultad'];
		$o->password=$_REQUEST['password'];
		$o->tipo_usuario=$_REQUEST['tipo_usuario'];
