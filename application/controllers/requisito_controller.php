...
class Requisito_controller extends Controller {//@
    private $data;
	private $myModel='Requisito_model';//@
    
    function Requisito_controller(){//@
        parent::Controller();
	...
	function cargaModulo($nombreTab='',$inputBuscador=false,$keyTab='',$keyTab='',$keyTab=''){//******************@ AGREGAR TANTOS KEYTAB COMO FK TENGA LA TABLA
		...
		$this->data['controller']="requisito_controller";//@lowercase
		$this->data['nombreModulo']="Requisito";//@
        $this->load->view('backend/requisito',$this->data);//@
    }
