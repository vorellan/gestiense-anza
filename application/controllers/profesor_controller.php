...
class Profesor_controller extends Controller {//@
    private $data;
	private $myModel='Profesor_model';//@
    
    function Profesor_controller(){//@
        parent::Controller();
	...
	function cargaModulo($nombreTab='',$inputBuscador=false,$keyTab=''){//@ AGREGAR TANTOS KEYTAB COMO FK TENGA LA TABLA
		...
		$this->data['controller']="profesor_controller";//@lowercase
		$this->data['nombreModulo']="Profesor";//@
        $this->load->view('backend/profesor',$this->data);//@
    }
